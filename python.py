...
<!-- Conteudo -->
<h1>Comunicação Industrial</h1>

<p>Bem vindos à comunicação industrial web!

<p>Nesta pagina você verá a comunicação feita entre dois robôs, e
como poderá ser o gerenciamento de uma industria em um futuro próximo.
Ela contém links que o ajudarão.
